...
app.controller('typeTemplateController', function ($scope, $controller, typeTemplateService, specificationService, brandService) {
    ...
    $scope.findBrandsList = function () {
        brandService.findOptionsList().success(
            function (response) {
    ...
    $scope.findSpecificationsList = function () {
        specificationService.findOptionsList().success(
            function (response) {
    ...
    $scope.delCustoms = function (index) {
