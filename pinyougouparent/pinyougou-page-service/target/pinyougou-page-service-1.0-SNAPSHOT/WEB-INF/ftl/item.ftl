                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <#if imgList?size gt 0>
                            <span class="jqzoom"><img jqimg="${imgList[0].url}" src="${imgList[0].url}" width="400px"
                                                      height="400px"/></span>
                        </#if>
                    </div>
                    <!--下方的缩略图-->
                            ...
                            <#list specificationList as specification>
                                <dl>
                                    ...
                                    <#list specification.attributeValue as item>
                                        <dd>
                                            <a href="javascript:;"
                                               ng-click="addSpec('${specification.attributeName}','${item}')"
                        ...
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="javascript:void(0)" class="increment plus" ng-click="addItem(1)">+</a>
                                    <a href="javascript:void(0)" class="increment mins" ng-click="addItem(-1)">-</a>
                                </div>
                            </div>
                        </div>
                        <div class="fl">
                        ...
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                <#if customAttributeList??>
                                    <#list customAttributeList as attribute>
                                        <#if attribute.value??>
