...
public class AddressController {
	 ...
	 */
	@RequestMapping("/add")
	public Message add(@RequestBody TbAddress address){
		try {
	...
	public Message update(@RequestBody TbAddress address){
		try {
	...
	@RequestMapping("/findAddressByUserName")
	public List<TbAddress> findAddressByUserName() {
